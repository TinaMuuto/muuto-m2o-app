...
* **Step 1: Select Product Family & Combinations:**
    ...
    * **Step 1a: Specify Base Colors (if applicable):** For items where multiple base colors are available, you can select one or more options.
...
if files_loaded_successfully:
    ...
    # --- Step 1a: Specify Base Colors (if applicable) ---
